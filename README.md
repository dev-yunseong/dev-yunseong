...
## Contacts
[Tistory](https://blog.yunseong.dev/) | [Github](https://github.com/dev-yunseong) | [Email](mailto:me@yunseong.dev)

## Projects & Experiences
### [Metropolitan Ring Road System](https://yunseong.dev/public/memos/134) (2026.02)
...
### [Maechuri](https://yunseong.dev/public/memos/70) (2025.12 ~ 2026.03)
- LLM·RAG 기반으로 AI 용의자와 자유롭게 대화하며 사건을 추리하는 웹 게임 개발
- Agent와 RAG 기반 파이프라인으로 매일 새로운 사건 시나리오 자동 생성
- IP·Fingerprint·Cookie 기반 클라이언트 식별로 LLM API 비용 및 어뷰징 방지 Rate Limiting 구현 [라이브러리](https://github.com/dev-yunseong/api-limit-webflux/packages/2810922)
- 이미지 생성 모델을 활용해 게임 내 시각 리소스를 자동 생성하는 AI 디자인 파이프라인 구축
### [P-ting](https://yunseong.dev/public/memos/46) (2025.08 ~ 2025.11)
- 교내 스포츠 매칭 플랫폼을 구현
- 회원 관리, 퀵 매칭, MMR 기반 랭크, 경기 후 평가, 기록 기능 구현
- ADR과 테스트 코드로 의사결정과 품질을 체계적으로 관리
### [Arcane Casters](https://yunseong.dev/public/memos/34) (2025.04 ~ )
...
### [두도지](https://yunseong.dev/public/memos/35) (2025.01 ~ 2025.09)
...
### [경단](https://yunseong.dev/public/memos/36) (2024.06 ~ 2024.07)
- FastAPI로 백엔드 구현, 협업 필터링 기반 추천 시스템과 메일 발송 기능 개발
- SW 중심대학 디지털 경진대회 본선 진출 성과 달성
### [Awake](http://awake25.com/) (2024.05 ~ 2024.12)
- 졸음 운전 방지용 LLM 챗봇 및 Flutter 앱 개발
- 3개 해커톤에서 수상, Android 기술과 LLM, 음성 기반 인터페이스 경험

## Awards
- 2025 CSE TECHWEEK 바이브코딩을 활용한 해커톤 대회 - 2등
- 제4회 PNU Coding Challenge - 장려상
- 2024 부산 디지털 혁신 아카데미 해커톤 - 혁신상
- 제5회 PNU 창의 융합 해커톤 - 최우수상
- 제11회 대한민국 SW 융합 해커톤 - 우수상
- 2024 공공 빅데이터 활용 경진대회 - 장려상
